...
public class AndroidBackupHandler extends BackupAgent {
	...
	// Both of these do nothing. This handler is here to support use of android 4.0+
	// ADB backup
	// and android 6.0+ auto-backup. It does not support android 2.2+ key-value
	// backup
	...
	public void onFullBackup(FullBackupDataOutput data) {
		// fully overrides super.onFullBackup, meaning only files specified here are
		// backed up
