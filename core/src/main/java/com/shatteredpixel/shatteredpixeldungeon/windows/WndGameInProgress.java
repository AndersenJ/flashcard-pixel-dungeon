...
public class WndGameInProgress extends Window {
	...
	public WndGameInProgress(final int slot) {
		...
		// manually produces debug information about a run, mainly useful for levelgen
		// errors
			...
			protected boolean onLongClick() {
				try {
					...
					ShatteredPixelDungeon.scene()
							.addToFront(new WndMessage("_Debug Info:_\n\n" + "Version: " + Game.version + " (" + Game.versionCode
		...
		RedButton erase = new RedButton(Messages.get(this, "erase")) {
			...
			protected void onClick() {
				...
				ShatteredPixelDungeon.scene()
						.add(new WndOptions(Messages.get(WndGameInProgress.class, "erase_warn_title"),
