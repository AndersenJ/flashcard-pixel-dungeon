...
public class WndMysticalCardQuestion extends WndMysticalCard {
  public WndMysticalCardQuestion(IFlashQuestion question) {
    super(question);
  }
  ...
  public int renderInputs(final int height, final int width) {
    RedButton btn = new RedButton("Reveal Answer", 8) {
      ...
      protected void onClick() {
        super.onClick();
        GameScene.show(new WndMysticalCardAnswer(question));
        hide();
      }
    };
