...
public class WndMysticalCardReward extends Window {
  ...
  public static WndMysticalCardReward instance;

  public WndMysticalCardReward() {
    ...
    MysticalCard card;
    try {
      card = MysticalCard.class.getDeclaredConstructor().newInstance();
