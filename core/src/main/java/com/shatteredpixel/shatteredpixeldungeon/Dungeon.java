...
public class Dungeon {
	...
	public static enum LimitedDrops {
		// limited world drops
		STRENGTH_POTIONS, UPGRADE_SCROLLS, ARCANE_STYLI,

		// Health potion sources
		// enemies
		SWARM_HP, NECRO_HP, BAT_HP, WARLOCK_HP, SCORPIO_HP,
		// alchemy
		...
		// containers
		DEW_VIAL, VELVET_POUCH, SCROLL_HOLDER, POTION_BANDOLIER, MAGICAL_HOLSTER;
	...
	public static void switchLevel(final Level level, int pos) {
		...
		if (bow != null && bow.spentUpgrades() > 0) {
			...
			// to prevent exploits, some SoU are lost in the conversion of a boomerang
			// higher than +1
		...
		try {
			 ...
			 * can go wrong catastrophically. But when they do the user will get a nice
			 * 'report this issue' dialogue, and I can fix the bug.
			 */
		}
	}
	...
	public static void dropToChasm(Item item) {
		...
		List<Item> dropped = Dungeon.droppedItems.get(depth);
		if (dropped == null) {
	...
	// TODO hero max vision is now separate from shadowcaster max vision. Might want
	// to adjust.
