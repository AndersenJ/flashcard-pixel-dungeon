...
public class Notes {
	...
	public static class LandmarkRecord extends Record {
		...
		public boolean equals(Object obj) {
			return (obj instanceof LandmarkRecord) && landmark == ((LandmarkRecord) obj).landmark
	...
	public static class KeyRecord extends Record {
		...
		@Override
		public boolean equals(Object obj) {
			return (obj instanceof KeyRecord) && key.isSimilar(((KeyRecord) obj).key);
		}
	...
	public static <T extends Record> List<T> getRecords(Class<T> recordType) {
		List<T> filtered = new ArrayList<>();
		for (Record rec : records) {
			if (recordType.isInstance(rec)) {
				filtered.add(recordType.cast(rec));
			}
		}
		return filtered;
	}
