...
public class UnstableSpellbook extends Artifact {
	...
	private final List<Class<?>> scrolls = new ArrayList<>();
		...
		if (action.equals(AC_READ)) {
			...
			if (hero.buff(Blindness.class) != null)
				...
				if (charge > 0 && !scrolls.contains(scroll.getClass())) {
					...
					GameScene.show(new WndOptions(Messages.get(this, "prompt"), Messages.get(this, "read_empowered"),
							scroll.trueName(), Messages.get(ExoticScroll.regToExo.get(scroll.getClass()), "name")) {
						@Override
