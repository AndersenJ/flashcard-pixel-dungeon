...
abstract public class Weapon extends KindOfWeapon {
	...
	public enum Augment {
		SPEED(0.7f, 0.6667f), DAMAGE(1.5f, 1.6667f), NONE(1.0f, 1.0000f);
	...
	public static abstract class Enchantment implements Bundlable {
		...
		private static final Class<?>[] common = new Class<?>[] { Blazing.class, Chilling.class, Kinetic.class,
				Shocking.class };

		private static final Class<?>[] uncommon = new Class<?>[] { Blocking.class, Blooming.class, Elastic.class,
				Lucky.class, Projecting.class, Unstable.class };

		private static final Class<?>[] rare = new Class<?>[] { Corrupting.class, Grim.class, Vampiric.class };
		...
		private static final Class<?>[] curses = new Class<?>[] { Annoying.class, Displacing.class, Exhausting.class,
				Fragile.class, Sacrificial.class, Wayward.class, Polarized.class, Friendly.class };
		...
		public static Enchantment randomCommon(Class<? extends Enchantment>... toIgnore) {
			List<Class<?>> enchants = new ArrayList<>(Arrays.asList(common));
		...
		public static Enchantment randomUncommon(Class<? extends Enchantment>... toIgnore) {
			List<Class<?>> enchants = new ArrayList<>(Arrays.asList(uncommon));
			enchants.removeAll(Arrays.asList(toIgnore));
			if (enchants.isEmpty()) {
				return random();
			} else {
		...
		public static Enchantment randomRare(Class<? extends Enchantment>... toIgnore) {
			List<Class<?>> enchants = new ArrayList<>(Arrays.asList(rare));
			enchants.removeAll(Arrays.asList(toIgnore));
			if (enchants.isEmpty()) {
				return random();
			} else {
		...
		public static Enchantment randomCurse(Class<? extends Enchantment>... toIgnore) {
			List<Class<?>> enchants = new ArrayList<>(Arrays.asList(curses));
			enchants.removeAll(Arrays.asList(toIgnore));
			if (enchants.isEmpty()) {
				return random();
			} else {
