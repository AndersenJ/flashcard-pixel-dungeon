...
public abstract class TippedDart extends Dart {
	...
	public void execute(final Hero hero, String action) {
		if (action.equals(AC_CLEAN)) {
			...
			GameScene.show(new WndOptions(Messages.get(this, "clean_title"), Messages.get(this, "clean_desc"),
					Messages.get(this, "clean_all"), Messages.get(this, "clean_one"), Messages.get(this, "cancel")) {
				@Override
