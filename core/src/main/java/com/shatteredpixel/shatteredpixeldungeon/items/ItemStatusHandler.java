...
public class ItemStatusHandler<T extends Item> {
	...
	public ItemStatusHandler(Class<? extends T>[] items, HashMap<String, Integer> labelImages) {
		...
		List<String> labelsLeft = new ArrayList<>(labelImages.keySet());
	...
	public ItemStatusHandler(Class<? extends T>[] items, HashMap<String, Integer> labelImages, Bundle bundle) {
		...
		List<String> allLabels = new ArrayList<>(labelImages.keySet());
	...
	public void saveClassesSelectively(Bundle bundle, List<Class<? extends Item>> clsToSave) {
		List<Class<? extends T>> items = Arrays.asList(this.items);
	...
	private void restore(Bundle bundle, List<String> labelsLeft) {
		...
		List<Class<? extends T>> unlabelled = new ArrayList<>();
