...
public class WandOfFireblast extends DamageWand {
	...
	protected void onZap(Ballistica bolt) {
		...
		List<Char> affectedChars = new ArrayList<>();
	...
	protected void fx(Ballistica bolt, Callback callback) {
		...
		for (int cell : visualCells) {
			...
			((MagicMissile) curUser.sprite.parent.recycle(MagicMissile.class)).reset(MagicMissile.FIRE_CONE, curUser.sprite,
					cell, null);
		}
		MagicMissile.boltFromChar(curUser.sprite.parent, MagicMissile.FIRE_CONE, curUser.sprite, bolt.path.get(dist / 2),
				callback);
