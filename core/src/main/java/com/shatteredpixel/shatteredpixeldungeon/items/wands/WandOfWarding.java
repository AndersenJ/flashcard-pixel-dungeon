...
public class WandOfWarding extends Wand {
	...
	protected void fx(Ballistica bolt, Callback callback) {
		MagicMissile m = MagicMissile.boltFromChar(curUser.sprite.parent, MagicMissile.WARD, curUser.sprite,
	...
	public static class Ward extends NPC {
		...
		public boolean interact() {
			Game.runOnRenderThread(new Callback() {
				...
				public void call() {
					GameScene
							.show(new WndOptions(Messages.get(Ward.this, "dismiss_title"), Messages.get(Ward.this, "dismiss_body"),
									Messages.get(Ward.this, "dismiss_confirm"), Messages.get(Ward.this, "dismiss_cancel")) {
								@Override
