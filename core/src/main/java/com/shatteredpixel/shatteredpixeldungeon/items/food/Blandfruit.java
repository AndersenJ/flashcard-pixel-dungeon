...
public class Blandfruit extends Food {
	...
	public boolean isSimilar(Item item) {
		if (super.isSimilar(item)) {
			...
			if (potionAttrib == null && other.potionAttrib == null) {
				return true;
			} else if (potionAttrib != null && other.potionAttrib != null && potionAttrib.isSimilar(other.potionAttrib)) {
				return true;
			}
		}
		return false;
	...
	public String desc() {
		if (potionAttrib == null) {
			...
			if (potionAttrib instanceof PotionOfFrost || potionAttrib instanceof PotionOfLiquidFlame
					|| potionAttrib instanceof PotionOfToxicGas || potionAttrib instanceof PotionOfParalyticGas) {
	...
	protected void onThrow(int cell) {
		...
		} else if (potionAttrib instanceof PotionOfLiquidFlame || potionAttrib instanceof PotionOfToxicGas
				|| potionAttrib instanceof PotionOfParalyticGas || potionAttrib instanceof PotionOfFrost
				|| potionAttrib instanceof PotionOfLevitation || potionAttrib instanceof PotionOfPurity) {
	...
	public static class CookFruit extends Recipe {
		...
		public boolean testIngredients(List<Item> ingredients) {
			...
			if (fruit.quantity() >= 1 && fruit.potionAttrib == null && seed.quantity() >= 1) {

				if (Dungeon.isChallenged(Challenges.NO_HEALING) && seed instanceof Sungrass.Seed) {
					return false;
				}
