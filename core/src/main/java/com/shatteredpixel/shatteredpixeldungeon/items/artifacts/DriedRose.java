...
public class DriedRose extends Artifact {
	...
	public static class GhostHero extends NPC {
		...
		protected Char chooseEnemy() {
			...
			if (enemy != null && Dungeon.level.mobs.contains(enemy) && (Dungeon.level.distance(enemy.pos, targetPos) <= 8)) {
				return enemy;
			}
		...
		public boolean isImmune(Class<?> effect) {
			if (effect == Burning.class && rose != null && rose.armor != null && rose.armor.hasGlyph(Brimstone.class, this)) {
				return true;
			}
