...
public class WandOfCorruption extends Wand {
	...
	protected void onZap(Ballistica bolt) {
		...
		if (ch != null) {
			...
			if (ch instanceof Mimic || ch instanceof Statue) {
				...
				// divide by 3 as wraiths are always at full HP and are therefore ~3x harder to
				// corrupt
	...
	protected void fx(Ballistica bolt, Callback callback) {
		MagicMissile.boltFromChar(curUser.sprite.parent, MagicMissile.SHADOW, curUser.sprite, bolt.collisionPos, callback);
