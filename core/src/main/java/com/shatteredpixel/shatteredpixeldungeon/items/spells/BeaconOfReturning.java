...
public class BeaconOfReturning extends Spell {
	...
	protected void onCast(final Hero hero) {
		...
		if (returnDepth == -1) {
			...
			GameScene.show(new WndOptions(Messages.titleCase(name()), Messages.get(BeaconOfReturning.class, "wnd_body"),
					Messages.get(BeaconOfReturning.class, "wnd_set"), Messages.get(BeaconOfReturning.class, "wnd_return")) {
				@Override
