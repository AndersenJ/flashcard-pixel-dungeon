...
public abstract class Scroll extends Item {
	...
	private static final Class<?>[] scrolls = { ScrollOfIdentify.class, ScrollOfMagicMapping.class,
			ScrollOfRecharging.class, ScrollOfRemoveCurse.class, ScrollOfTeleportation.class, ScrollOfUpgrade.class,
	...
	public static class ScrollToStone extends Recipe {
		...
		public boolean testIngredients(List<Item> ingredients) {
			if (ingredients.size() != 1 || !ingredients.get(0).isIdentified() || !(ingredients.get(0) instanceof Scroll)
