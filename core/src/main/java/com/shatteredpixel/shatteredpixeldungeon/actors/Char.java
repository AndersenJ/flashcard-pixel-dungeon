...
public abstract class Char extends Actor {
	...
	public void damage(int dmg, Object src) {
		...
		int shielded = dmg;
		// FIXME: when I add proper damage properties, should add an IGNORES_SHIELDS
	...
	public enum Property {
		...
		MINIBOSS(new HashSet<Class<?>>(), new HashSet<Class<?>>(Arrays.asList(Corruption.class))), UNDEAD, DEMONIC,
		INORGANIC(new HashSet<Class<?>>(),
				new HashSet<Class<?>>(Arrays.asList(Bleeding.class, ToxicGas.class, Poison.class))),
		BLOB_IMMUNE(new HashSet<Class<?>>(), new HashSet<Class<?>>(Arrays.asList(Blob.class))),
		...
		ELECTRIC(new HashSet<Class<?>>(
				Arrays.asList(WandOfLightning.class, Shocking.class, Potential.class, Electricity.class, ShockingDart.class)),
				new HashSet<Class<?>>()),
		IMMOVABLE;
