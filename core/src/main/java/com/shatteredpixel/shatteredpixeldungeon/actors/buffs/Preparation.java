...
public class Preparation extends Buff implements ActionIndicator.Action {
	...
	public enum AttackLevel {
		LVL_1(1, 0.1f, 0.0f, 1, 0), LVL_2(3, 0.2f, 0.0f, 1, 1), LVL_3(6, 0.3f, 0.0f, 2, 3), LVL_4(11, 0.4f, 0.6f, 2, 5),
		...
		public boolean canInstakill(Char defender) {
			return this == LVL_5 && !defender.properties().contains(Char.Property.MINIBOSS)
	...
	public int damageRoll(Char attacker, Char defender) {
		...
		if (lvl.canInstakill(defender)) {
			...
			// even though the defender is dead, other effects should still proc (enchants,
			// etc.)
	...
	public String desc() {
		...
		if (lvl.canInstakill(new Rat())) {
			...
			desc += "\n\n" + Messages.get(this, "desc_dmg_scale", (int) (lvl.baseDmgBonus * 100),
					(int) (lvl.baseDmgBonus * 100 + lvl.missingHPBonus * 100));
		} else {
