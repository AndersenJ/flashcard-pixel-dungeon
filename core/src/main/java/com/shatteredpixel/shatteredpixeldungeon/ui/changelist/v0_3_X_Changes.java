...
public class v0_3_X_Changes {
	...
	public static void add_v0_3_5_Changes(List<ChangeInfo> changeInfos) {
		ChangeInfo changes = new ChangeInfo("v0.3.5", false, "");
		changes.hardlight(Window.TITLE_COLOR);
		changeInfos.add(changes);

		changes.addButton(new ChangeButton(Icons.get(Icons.SHPX), "Developer Commentary", "_-_ Released May 1st, 2016\n"
	...
	public static void add_v0_3_4_Changes(List<ChangeInfo> changeInfos) {
		ChangeInfo changes = new ChangeInfo("v0.3.4", false, "");
		changes.hardlight(Window.TITLE_COLOR);
		changeInfos.add(changes);

		changes
				.addButton(new ChangeButton(Icons.get(Icons.SHPX), "Developer Commentary", "_-_ Released February 10th, 2016\n"
	...
	public static void add_v0_3_3_Changes(List<ChangeInfo> changeInfos) {
		ChangeInfo changes = new ChangeInfo("v0.3.3", false, "");
		changes.hardlight(Window.TITLE_COLOR);
		changeInfos.add(changes);

		changes
				.addButton(new ChangeButton(Icons.get(Icons.SHPX), "Developer Commentary", "_-_ Released December 18th, 2015\n"
	...
	public static void add_v0_3_2_Changes(List<ChangeInfo> changeInfos) {
		ChangeInfo changes = new ChangeInfo("v0.3.2", false, "");
		changes.hardlight(Window.TITLE_COLOR);
		changeInfos.add(changes);

		changes
				.addButton(new ChangeButton(Icons.get(Icons.SHPX), "Developer Commentary", "_-_ Released November 4th, 2015\n"
	...
	public static void add_v0_3_1_Changes(List<ChangeInfo> changeInfos) {
		ChangeInfo changes = new ChangeInfo("v0.3.1", false, "");
		changes.hardlight(Window.TITLE_COLOR);
		changeInfos.add(changes);

		changes.addButton(new ChangeButton(Icons.get(Icons.SHPX), "Developer Commentary", "_-_ Released August 17th, 2015\n"
	...
	public static void add_v0_3_0_Changes(List<ChangeInfo> changeInfos) {
