...
public class v0_6_X_Changes {
	...
	public static void add_v0_6_5_Changes(List<ChangeInfo> changeInfos) {
		...
		changes.addButton(new ChangeButton(Icons.get(Icons.SHPX), "Developer Commentary", "_-_ Released May 3rd, 2018\n"
		...
		changes.addButton(new ChangeButton(new ItemSprite(ItemSpriteSheet.SWORD, new Lucky().glowing()),
				"Lucky Enchantment",
		...
		changes.addButton(new ChangeButton(new ItemSprite(ItemSpriteSheet.SHORTSWORD, new Wayward().glowing()),
				"Wayward curse",
	...
	public static void add_v0_6_4_Changes(List<ChangeInfo> changeInfos) {
		...
		changes.addButton(new ChangeButton(Icons.get(Icons.SHPX), "Developer Commentary", "_-_ Released April 1st, 2018\n"
	...
	public static void add_v0_6_3_Changes(List<ChangeInfo> changeInfos) {
		...
		changes
				.addButton(new ChangeButton(Icons.get(Icons.SHPX), "Developer Commentary", "_-_ Released February 14th, 2018\n"
		...
		changes.addButton(new ChangeButton(new ItemSprite(ItemSpriteSheet.RING_TOPAZ, null),
				Messages.get(RingOfSharpshooting.class, "name"),
		...
		changes.addButton(new ChangeButton(new Image(Assets.BUFFS_LARGE, 32, 0, 16, 16),
				"Changes to debuffs and resistances",
		...
		changes.addButton(new ChangeButton(new ItemSprite(ItemSpriteSheet.RING_EMERALD, null),
				Messages.get(RingOfElements.class, "name"),
	...
	public static void add_v0_6_2_Changes(List<ChangeInfo> changeInfos) {
		...
		changes
				.addButton(new ChangeButton(Icons.get(Icons.SHPX), "Developer Commentary", "_-_ Released October 24th, 2017\n"
		...
		changes.addButton(new ChangeButton(new WandOfCorruption(), "The Wand of Corruption has been reworked!\n\n"
	...
	public static void add_v0_6_1_Changes(List<ChangeInfo> changeInfos) {
		...
		changes.addButton(new ChangeButton(Icons.get(Icons.SHPX), "Developer Commentary", "_-_ Released August 15th, 2017\n"
		...
		changes.addButton(
				new ChangeButton(new ItemSprite(ItemSpriteSheet.CHEST, null), "Sprites", "New sprites for the following:\n"
						+ "_-_ Chests & Mimics\n" + "_-_ Darts\n" + "_-_ Javelins\n" + "_-_ Tomahawks"));
		...
		changes.addButton(new ChangeButton(new ItemSprite(ItemSpriteSheet.RING_AMETHYST, null),
	...
	public static void add_v0_6_0_Changes(List<ChangeInfo> changeInfos) {
		ChangeInfo changes = new ChangeInfo("v0.6.0", true, "");
		changes.hardlight(Window.TITLE_COLOR);
		changeInfos.add(changes);

		changes.addButton(new ChangeButton(Icons.get(Icons.SHPX), "Developer Commentary", "_-_ Released June 4th, 2017\n"
