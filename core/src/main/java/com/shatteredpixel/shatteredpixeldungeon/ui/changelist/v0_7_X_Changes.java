...
public class v0_7_X_Changes {
	...
	public static void addAllChanges(List<ChangeInfo> changeInfos) {
	...
	public static void add_v0_7_5_Changes(List<ChangeInfo> changeInfos) {
		...
		changes.addButton(
				new ChangeButton(new Image(Assets.SPINNER, 144, 0, 16, 16), Messages.get(ChangesScene.class, "bugfixes"),
		...
		changes.addButton(
				new ChangeButton(Icons.get(Icons.LANGS), Messages.get(ChangesScene.class, "language"), "Updated Translations"));
		...
		changes.addButton(new ChangeButton(Icons.get(Icons.SHPX), "Developer Commentary", "_-_ Released October 2nd, 2019\n"
		...
		changes.addButton(new ChangeButton(new ItemSprite(ItemSpriteSheet.LONGSWORD, new ItemSprite.Glowing(0x440066)),
				"Glyph/Enchant Buffs",
	...
	public static void add_v0_7_4_Changes(List<ChangeInfo> changeInfos) {
		...
		changes.addButton(new ChangeButton(Icons.get(Icons.SHPX), "Developer Commentary", "_-_ Released July 18th, 2019\n"
		...
		changes.addButton(new ChangeButton(new ItemSprite(ItemSpriteSheet.LONGSWORD, new ItemSprite.Glowing(0xFF4400)),
				"Enchant/Glyph Buffs",
		...
		changes.addButton(new ChangeButton(new ItemSprite(ItemSpriteSheet.ARMOR_MAIL, new ItemSprite.Glowing(0x88EEFF)),
				"Glyph Nerfs",
	...
	public static void add_v0_7_3_Changes(List<ChangeInfo> changeInfos) {
		...
		changes.addButton(new ChangeButton(Icons.get(Icons.SHPX), "Developer Commentary", "_-_ Released May 23rd, 2019\n"
				+ "_-_ 66 days after Shattered v0.7.2" + "\n" + "Dev commentary will be added here in the future."));

		changes.addButton(new ChangeButton(new ItemSprite(ItemSpriteSheet.LONGSWORD, new ItemSprite.Glowing(0xFFFF00)),
				"Enchantment Changes",
		...
		changes.addButton(new ChangeButton(new ItemSprite(ItemSpriteSheet.ARMOR_SCALE, new ItemSprite.Glowing(0x663300)),
				"Enchant/Glyph Buffs",
		...
		changes.addButton(new ChangeButton(new ItemSprite(ItemSpriteSheet.ARMOR_PLATE, new ItemSprite.Glowing(0x660022)),
				"Enchant/Glyph Nerfs",
	...
	public static void add_v0_7_2_Changes(List<ChangeInfo> changeInfos) {
		...
		changes.addButton(new ChangeButton(Icons.get(Icons.SHPX), "Developer Commentary", "_-_ Released Mar 18th, 2019\n"
		...
		changes.addButton(new ChangeButton(new ItemSprite(ItemSpriteSheet.LONGSWORD, new ItemSprite.Glowing(0x0000FF)),
		...
		changes.addButton(new ChangeButton(new Image(Assets.SPINNER, 144, 0, 16, 16),
		...
		changes.addButton(
				new ChangeButton(new ItemSprite(ItemSpriteSheet.RING_AMETHYST, null), Messages.get(RingOfWealth.class, "name"),
		...
		changes.addButton(new ChangeButton(new ItemSprite(ItemSpriteSheet.SPEAR, new ItemSprite.Glowing(0x00FFFF)),
				"Buffed Enchants", "_-_ Chilling now stacks with itself over multiple procs\n\n"
						+ "_-_ Lucky buffed/reworked. No longer affects damage, now generates bonus items when enemies are killed with a lucky weapon."));

		changes.addButton(new ChangeButton(new ItemSprite(ItemSpriteSheet.SEED_SWIFTTHISTLE, null),
		...
		changes.addButton(new ChangeButton(new ItemSprite(ItemSpriteSheet.DIRK, new ItemSprite.Glowing(0xFF4400)),
				"Nerfed Enchants",
	...
	public static void add_v0_7_1_Changes(List<ChangeInfo> changeInfos) {
		...
		changes.addButton(new ChangeButton(Icons.get(Icons.SHPX), "Developer Commentary", "_-_ Released Dec 18th, 2018\n"
		...
		changes.addButton(
				new ChangeButton(new ItemSprite(ItemSpriteSheet.ARMOR_LEATHER, new ItemSprite.Glowing(0x222222)), "Other Buffs",
		...
		changes.addButton(new ChangeButton(new Shuriken(), "Shuriken have been adjusted due to the new upgrade system:\n\n"
				+ "_-_ Base damage increased to 4-8 from 4-6\n" + "_-_ Durability reduced to 5 from 10"));
	}

	public static void add_v0_7_0_Changes(List<ChangeInfo> changeInfos) {
		...
		changes.addButton(new ChangeButton(new AlchemistsToolkit(), "The Alchemist's Toolkit returns!\n\n"
		...
		changes.addButton(new ChangeButton(new ItemSprite(ItemSpriteSheet.SCROLL_KAUNAN, null),
				new ScrollOfTeleportation().trueName(),
		...
		changes.addButton(new ChangeButton(new ItemSprite(ItemSpriteSheet.SCROLL_ODAL, null),
				new ScrollOfMirrorImage().trueName(),
		...
		changes.addButton(new ChangeButton(new ItemSprite(ItemSpriteSheet.SCROLL_NAUDIZ, null),
				new ScrollOfTerror().trueName(),
		...
		changes.addButton(new ChangeButton(new ItemSprite(ItemSpriteSheet.SCROLL_GYFU, null),
				new ScrollOfRetribution().trueName(),
		...
		changes.addButton(new ChangeButton(new ItemSprite(ItemSpriteSheet.POTION_CRIMSON, null),
				new PotionOfHealing().trueName(),
