...
public class HeroSprite extends CharSprite {
	...
	public void bloodBurstA(PointF from, int damage) {
		 ...
		 * violence towards human characters. The heroes are the only human or
		 * human-like characters which participate in combat, so removing all blood
		 * associated with them is a simple way to reduce the violence rating of the
		 * game.
		 */
	}
