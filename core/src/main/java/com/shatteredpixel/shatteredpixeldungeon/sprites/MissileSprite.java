...
public class MissileSprite extends ItemSprite implements Tweener.Listener {
	...
	// TODO it might be nice to have a source and destination angle, to improve
	// thrown weapon visuals
	private void setup(PointF from, PointF to, Item item, Callback listener) {
		...
		} else if (item instanceof SpiritBow.SpiritArrow || item instanceof ScorpioSprite.ScorpioShot
