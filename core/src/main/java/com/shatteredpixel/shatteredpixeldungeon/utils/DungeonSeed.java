...
public class DungeonSeed {
	...
	// Seed codes take the form @@@-@@@-@@@ where @ is any letter from A to Z (only
	// uppercase)
	// This is effectively a base-26 number system, therefore 26^9 unique seeds are
	// possible.
	...
	// Using this we can let users input 'fun' plaintext seeds and convert them to a
	// long equivalent.
	// This is basically the same as string.hashcode except with long, and
