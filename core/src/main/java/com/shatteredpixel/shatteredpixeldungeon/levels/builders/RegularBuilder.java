...
public abstract class RegularBuilder extends Builder {
	...
	protected List<Room> multiConnections = new ArrayList<>();
	protected List<Room> singleConnections = new ArrayList<>();
	...
	protected void setupRooms(List<Room> rooms) {
		...
		// this weights larger rooms to be much more likely to appear in the main loop,
		// by placing them earlier in the multiconnections list
	...
	// note that the three arrays should be separate, they may contain the same
	// rooms however
	protected void createBranches(List<Room> rooms, List<Room> branchable, List<Room> roomsToBranch,
			float[] connChances) {
		...
		int tries;
		Room curr;
		List<Room> connectingRoomsThisBranch = new ArrayList<>();
