...
public class AltarRoom extends SpecialRoom {
	...
	public void paint(Level level) {
		...
		// TODO: find some use for sacrificial fire... but not the vanilla one. scroll
		// of wipe out is too strong.
		/*
		 * SacrificialFire fire = (SacrificialFire)level.blobs.get(
		 * SacrificialFire.class ); if (fire == null) { fire = new SacrificialFire(); }
		 * fire.seed( c.x + c.y * Level.WIDTH, 5 + Dungeon.depth * 5 ); level.blobs.put(
		 * SacrificialFire.class, fire );
		 */
