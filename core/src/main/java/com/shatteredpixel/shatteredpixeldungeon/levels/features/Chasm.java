...
public class Chasm {
	...
	public static void heroJump(final Hero hero) {
		Game.runOnRenderThread(new Callback() {
			@Override
			public void call() {
				GameScene.show(new WndOptions(Messages.get(Chasm.class, "chasm"), Messages.get(Chasm.class, "jump"),
						Messages.get(Chasm.class, "yes"), Messages.get(Chasm.class, "no")) {
					@Override
	...
	public static void heroLand() {
		...
		// Hero has a 50% chance to bleed out at 66% HP, and begins to risk
		// instant-death at 25%
