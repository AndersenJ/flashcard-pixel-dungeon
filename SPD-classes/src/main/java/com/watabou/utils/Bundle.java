...
public class Bundle {
	...
	private Bundlable get() {
		...
		// Skip none-static inner classes as they can't be instantiated through bundle
		// restoring
		// Classes which make use of none-static inner classes must manage instantiation
		// manually
	...
	public Collection<Bundlable> getCollection(String key) {
		...
		List<Bundlable> list = new ArrayList<>();
