...
public abstract class PlatformSupport {
	...
	// FIXME this is currently used because no platform-agnostic text input has been
	// implemented.
	// should look into doing that using either plain openGL or Libgdx's libraries
	public abstract void promptTextInput(String title, String hintText, int maxLen, boolean multiLine, String posTxt,
			String negTxt, TextCallback callback);

	public static abstract class TextCallback {
		public abstract void onSelect(boolean positive, String text);
	}

	// TODO should consider spinning this into its own class, rather than platform
	// support getting ever bigger
