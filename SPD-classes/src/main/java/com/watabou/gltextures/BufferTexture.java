...
public class BufferTexture extends SmartTexture {
	...
	public void update() {
		...
		pixels.position(0);
		Gdx.gl.glTexImage2D(GL20.GL_TEXTURE_2D, 0, GL20.GL_RGBA, width, height, 0, GL20.GL_RGBA, GL20.GL_UNSIGNED_BYTE,
				pixels);
	}
	...
	public void update(int top, int bottom) {
		...
		Gdx.gl.glTexSubImage2D(GL20.GL_TEXTURE_2D, 0, 0, top, width, bottom - top, GL20.GL_RGBA, GL20.GL_UNSIGNED_BYTE,
				pixels);
	}
}
