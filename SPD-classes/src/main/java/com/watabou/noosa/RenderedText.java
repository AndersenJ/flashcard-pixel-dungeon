...
public class RenderedText extends Image {
	...
	private synchronized void measure() {
		...
		if (font != null) {
			...
			// this is identical to l.height in most cases, but we force this for
			// consistency.
	...
	protected void updateMatrix() {
		super.updateMatrix();
		// sometimes the font is rendered oddly, so we offset here to put it in the
		// correct spot
	...
	// implements regular PD rendering within a LibGDX batch so that our rendering
	// logic
